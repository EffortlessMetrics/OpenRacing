//! Standard USB HID PID effect reports for VRS DirectForce Pro wheelbases.
//!
//! VRS DirectForce Pro uses the standard USB HID PID (Physical Interface
//! Device) protocol for force feedback, confirmed by the Linux kernel driver
