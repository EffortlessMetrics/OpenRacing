...
use racing_wheel_service::config_writers::{ACCConfigWriter, Dirt5ConfigWriter, IRacingConfigWriter};
...
async fn test_dirt5_config_writer_golden() {
    ...
    let config = TelemetryConfig {
        ...
        fields: vec!["rpm".to_string(), "speed_ms".to_string(), "gear".to_string()],
        enable_high_rate_iracing_360hz: false,
    };
