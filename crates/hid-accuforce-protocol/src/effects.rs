//! Standard USB HID PID effect reports for AccuForce wheelbases.
//!
//! The SimExperience AccuForce Pro uses the standard USB HID PID (Physical
//! Interface Device) protocol for force feedback, operating at full-speed
//! USB (12 Mbit/s) with 100-200 Hz update rate.
//!
...
//! - AccuForce community USB captures (RetroBat Wheels.cs)
//! - Linux kernel `hid-pidff` driver support
...
pub fn encode_set_effect(
    ...
    // bytes 5-8: trigger repeat, sample period (default 0)
    buf[9] = gain;
