//! Standard USB HID PID effect reports for Leo Bodnar wheelbases.
//!
//! The Leo Bodnar Wheel Interface (PID 0x000E) and FFB Joystick (PID 0x000F)
//! use the standard USB HID PID (Physical Interface Device) protocol for
//! force feedback. The devices are supported by the Linux kernel `hid-pidff`
//! driver with no vendor-specific quirks.
//!
...
//! - Leo Bodnar product pages and community USB captures
