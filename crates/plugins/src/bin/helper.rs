...
fn read_frame_from_shared_memory(
    ...
    unsafe {
        let header = shared_memory.as_ptr() as *const SharedMemoryHeader;
        let frames_ptr = (header as *const u8).add(std::mem::size_of::<SharedMemoryHeader>())
            as *const PluginFrame;
...
fn write_frame_to_shared_memory(
    ...
    unsafe {
        ...
        let frames_ptr =
            (header as *mut u8).add(std::mem::size_of::<SharedMemoryHeader>()) as *mut PluginFrame;
