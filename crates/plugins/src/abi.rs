...
mod tests {
    ...
    fn test_plugin_capabilities_bitflags() {
        ...
        let valid_caps = PluginCapabilities::TELEMETRY | PluginCapabilities::LEDS | PluginCapabilities::HAPTICS;
    ...
    fn test_plugin_header_byte_exact_serialization() {
        ...
        let expected_bytes = [
            ...
            0x31, 0x4C, 0x57, 0x57,
            // abi_version: 0x00010000 in LE  
            0x00, 0x00, 0x01, 0x00,
            // capabilities: 0x00000003 in LE
            0x03, 0x00, 0x00, 0x00,
            // reserved: 0x00000000 in LE
            0x00, 0x00, 0x00, 0x00,
        ];
    ...
    fn test_capability_flags_reserved_bits() {
        ...
        let valid_mask = (PluginCapabilities::TELEMETRY | 
                         ...
                         PluginCapabilities::HAPTICS).bits();
