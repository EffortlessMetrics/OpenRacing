...
use crate::manager::FirmwareImage;
...
impl FirmwareBundle {
    ...
    pub fn new(
        ...
        let payload_hash = openracing_crypto::utils::compute_sha256_hex(&image.data);
    ...
    pub fn parse(data: &[u8]) -> Result<Self> {
        ...
        let (header, _header_bytes): (BundleHeader, Vec<u8>) =
        ...
        let signature: Option<openracing_crypto::SignatureMetadata> =
            read_json_block(&mut cursor).ok();
        ...
        let computed_hash = openracing_crypto::utils::compute_sha256_hex(&decompressed);
...
mod tests {
    ...
    fn test_bundle_write_and_load() -> Result<()> {
        ...
        let loaded = FirmwareBundle::load(&bundle_path)?;
    ...
    #[test]
    fn test_hardware_version_numeric_comparison() -> Result<()> {
