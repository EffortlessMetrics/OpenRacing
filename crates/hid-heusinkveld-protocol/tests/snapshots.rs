...
fn snapshot_is_heusinkveld_device() {
    let results = [
        ("current_vid", heusinkveld::is_heusinkveld_device(heusinkveld::HEUSINKVELD_VENDOR_ID)),
        ("legacy_vid", heusinkveld::is_heusinkveld_device(heusinkveld::HEUSINKVELD_LEGACY_VENDOR_ID)),
        ("handbrake_v1_vid", heusinkveld::is_heusinkveld_device(heusinkveld::HEUSINKVELD_HANDBRAKE_V1_VENDOR_ID)),
        ("shifter_vid", heusinkveld::is_heusinkveld_device(heusinkveld::HEUSINKVELD_SHIFTER_VENDOR_ID)),
