...
pub use ids::{product_ids, rim_ids, FANATEC_VENDOR_ID};
pub use ids::led_commands;
pub use input::{
    FanatecExtendedState, FanatecInputState, FanatecPedalState,
...
pub use types::{FanatecModel, FanatecPedalModel, FanatecRimId, is_pedal_product, is_wheelbase_product};
