//! Operator-supplied HID report descriptor input parsing for Moza CLI commands.
//!
//! This module keeps descriptor file/text parsing separate from command execution
//! so the command dispatcher remains focused on HID safety policy and receipts.
