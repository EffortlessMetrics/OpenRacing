//! Operator-supplied HID report descriptor input handling for Moza commands.
//!
//! This module owns the non-device-facing parsing paths used by `wheelctl moza
//! descriptor`: inline hex, text/hexdump files, and binary descriptor files. It
//! intentionally does not open HID devices or send reports.
