//! Operator-supplied HID report descriptor parsing and attachment.
//!
//! Keeping this text/binary descriptor input handling separate from the Moza
//! command orchestration keeps the main command module focused on workflows.
...
use super::{
    MozaDeviceRecord, bytes_hex_compact, parse_hex_bytes, parse_hex_u8_token,
    reject_unsupported_report_descriptor_bytes, report_descriptor_from_operator_hex,
    selector_matches,
};
...
pub(super) fn operator_report_descriptor_hex(
...
pub(super) fn operator_descriptor_source(
    inline_hex: Option<&str>,
    hex_file: Option<&Path>,
    bin_file: Option<&Path>,
) -> Option<&'static str> {
