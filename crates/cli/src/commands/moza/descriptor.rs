//! Operator-supplied HID report descriptor parsing for Moza CLI commands.
//!
//! This module keeps descriptor file parsing isolated from command execution so
//! device enumeration and output paths do not carry text/binary parsing details.
