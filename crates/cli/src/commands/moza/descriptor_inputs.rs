//! Report descriptor input readers and text normalizers for Moza CLI commands.
//!
//! This module owns the file-format concerns for descriptor inputs so the main
//! Moza command module can focus on command orchestration and receipt logic.
