use super::shared::{
    default_recorder_session_id, normalized_f64, now_utc, validated_normalized_snapshots,
    write_jsonl_values,
};
use super::{
    VIRTUAL_FFB_LOG_COMMAND, VIRTUAL_FFB_PRODUCT_ID, VIRTUAL_FFB_REPORT_FORMAT,
