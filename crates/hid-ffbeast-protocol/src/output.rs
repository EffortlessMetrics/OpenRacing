//! FFBeast HID output report encoding.
//!
//! FFBeast uses standard USB HID PID with a constant force report
...
///
/// FFBeast uses a signed 16-bit torque in the range [-10000, 10000].
pub const MAX_TORQUE_SCALE: i16 = 10_000;

/// Encodes torque commands for FFBeast devices.
///
/// Produces 5-byte constant force HID output reports.
#[derive(Debug, Clone, Copy, Default)]
pub struct FFBeastTorqueEncoder;
