...
const OPENFFBOARD_PIDS: &[(u16, &str)] = &[
    (0xFFB0, "Main"),
    (0xFFB1, "Alt (unverified)"),
];
...
fn vid_pid_registry_has_no_duplicates() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut registry: std::collections::HashMap<(u16, u16), &str> = std::collections::HashMap::new();
    ...
    let vendors: &[VendorVidPids] = &[
        ...
        ("Fanatec", 0x0EB7, &[
            (0x0001, "ClubSport V2"), (0x0004, "ClubSport V2.5"),
            (0x0005, "CSL Elite PS4"), (0x0006, "DD1"), (0x0007, "DD2"),
            (0x0011, "CSR Elite"), (0x0020, "CSL DD"), (0x0024, "GT DD Pro"),
            (0x0E03, "CSL Elite"), (0x01E9, "ClubSport DD"),
            (0x1839, "ClubSport Pedals V1/V2"), (0x183B, "ClubSport Pedals V3"),
            (0x6204, "CSL Elite Pedals"), (0x6205, "CSL Pedals LC"),
            (0x6206, "CSL Pedals V2"),
        ]),
        ("Logitech", 0x046D, &[
            (0xC295, "MOMO"), (0xC298, "DFP"), (0xC29A, "DFGT"),
            (0xC29C, "SFW"), (0xCA03, "MOMO 2"), (0xC293, "WFF GP"),
            (0xC291, "WFF"), (0xCA04, "Vibration"), (0xC299, "G25"),
            (0xC294, "DF EX"), (0xC29B, "G27"), (0xC24F, "G29"),
            (0xC262, "G920"), (0xC266, "G923"), (0xC267, "G923 PS"),
            (0xC26E, "G923 Xbox"), (0xC268, "G PRO"), (0xC272, "G PRO Xbox"),
        ]),
        ("Moza", 0x346E, &[
            (0x0000, "R16/R21 V1"), (0x0002, "R9 V1"), (0x0004, "R5 V1"),
            (0x0005, "R3 V1"), (0x0006, "R12 V1"), (0x0010, "R16/R21 V2"),
            (0x0012, "R9 V2"), (0x0014, "R5 V2"), (0x0015, "R3 V2"),
            (0x0016, "R12 V2"), (0x0003, "SR-P Pedals"), (0x0020, "HGP"),
            (0x0021, "SGP"), (0x0022, "HBP"),
        ]),
        ("Thrustmaster", 0x044F, &[
            (0xB65D, "Generic"), (0xB677, "T150"), (0xB65E, "T500 RS"),
            (0xB66D, "T300 PS4"), (0xB67F, "TMX"), (0xB66E, "T300"),
            (0xB66F, "T300 GT"), (0xB669, "TX Racing"), (0xB664, "TX Orig"),
            (0xB696, "T248"), (0xB69A, "T248X"), (0xB689, "TS-PC"),
            (0xB692, "TS-XW"), (0xB691, "TS-XW GIP"), (0xB69B, "T818"),
            (0xB668, "T80"), (0xB66A, "T80 Ferrari"), (0xB605, "NASCAR"),
            (0xB651, "FGT Rumble"), (0xB653, "RGT Clutch"),
            (0xB654, "FGT FFB"), (0xB65A, "F430 FFB"),
        ]),
        ("Simagic (EVO 0x3670)", 0x3670, &[
            (0x0500, "EVO Sport"), (0x0501, "EVO"), (0x0502, "EVO Pro"),
            (0x0600, "Alpha EVO"), (0x0700, "NEO"), (0x0701, "NEO Mini"),
            (0x1001, "P1000"), (0x1002, "P2000"), (0x1003, "P1000A"),
            (0x2001, "Shifter H"), (0x2002, "Shifter Seq"),
            (0x3001, "Handbrake"), (0x4001, "WR1"), (0x4002, "GT1"),
            (0x4003, "GT NEO"), (0x4004, "Formula"),
        ]),
        ("Asetek", 0x2433, &[
            (0xF300, "Invicta"), (0xF301, "Forte"),
            (0xF303, "La Prima"), (0xF306, "Tony Kanaan"),
        ]),
        ("FFBeast", 0x045B, &[
            (0x58F9, "Joystick"), (0x5968, "Rudder"), (0x59D7, "Wheel"),
        ]),
        ("Cammus", 0x3416, &[
            (0x0301, "C5"), (0x0302, "C12"),
            (0x1018, "CP5 Pedals"), (0x1019, "LC100 Pedals"),
        ]),
        ("AccuForce", 0x1FC9, &[(0x804C, "AccuForce Pro")]),
        ("Leo Bodnar", 0x1DD2, &[
            (0x0001, "USB Joystick"), (0x000C, "BBI32"),
            (0x000E, "Wheel Interface"), (0x000F, "FFB Joystick"),
            (0x1301, "SLI-M"), (0x000B, "BU0836A"),
            (0x0030, "BU0836X"), (0x0031, "BU0836 16-bit"),
        ]),
    ];
...
fn shared_vid_pid_ranges_do_not_overlap() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for &(vid, vendor_groups) in shared_vids {
        let mut pid_owner: std::collections::HashMap<u16, &str> =
