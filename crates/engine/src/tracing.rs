...
pub enum RTTraceEvent {
    /// RT tick started
    TickStart { tick_count: u64, timestamp_ns: u64 },
    /// RT tick completed
    TickEnd {
        tick_count: u64,
        timestamp_ns: u64,
...
impl WindowsETWProvider {
    fn emit_etw_event(
        ...
        use windows::Win32::System::Diagnostics::Etw::{EVENT_DESCRIPTOR, EventWrite};
    ...
    fn emit_etw_app_event(
        &self,
        handle: windows::Win32::System::Diagnostics::Etw::REGHANDLE,
        _event: AppTraceEvent,
    ) {
        use windows::Win32::System::Diagnostics::Etw::{EVENT_DESCRIPTOR, EventWrite};
