...
pub use racing_wheel_hid_ffbeast_protocol::{
    FFBEAST_PRODUCT_ID_JOYSTICK as PID_JOYSTICK, FFBEAST_PRODUCT_ID_RUDDER as PID_RUDDER,
    FFBEAST_PRODUCT_ID_WHEEL as PID_WHEEL, FFBEAST_VENDOR_ID as VENDOR_ID,
};
