...
- **Test Infrastructure**: 3,600+ tests, 70 fuzz targets, 34+ snapshot tests, property-based tests (proptest), E2E journey tests; all HID crates have cross-reference id_verification suites
